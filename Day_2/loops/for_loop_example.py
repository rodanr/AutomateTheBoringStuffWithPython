...
#loop section
for n in table_range : #the values of n changes from 1 to 10 ,for eg: n= 1 in iteration 1 and n=2 in interation 2 and loops continues until the list completes
